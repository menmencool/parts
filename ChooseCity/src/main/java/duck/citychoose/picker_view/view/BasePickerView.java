...
import duck.citychoose.picker_view.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public static int PICKERVIEW_GRAVITY = Gravity.BOTTOM; //让pickview的显示位置可控

    // TODO: 2017/9/25 控制时间选择器的显示位置
    private final FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, PICKERVIEW_GRAVITY
    );
